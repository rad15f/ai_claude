#!/usr/bin/env python3
"""
Generate ~1,500 bot-like YouTube comments using GPT-4o mini (OpenAI).
Output: dataset/bot_comments_gpt.csv

Usage:
    pip install openai
    OPENAI_API_KEY=sk-... python3 training/generate_bot_comments_gpt.py

Cost: ~$0.15 for 1,500 comments at GPT-4o mini pricing.
"""
...
OUTPUT_FILE  = OUTPUT_DIR / "bot_comments_gpt.csv"
...
def call_with_retry(client: OpenAI, topic: str, max_retries: int = 3) -> list:
    for attempt in range(max_retries):
        try:
            ...
            sys.exit("ERROR: Invalid OPENAI_API_KEY.")
...
def main() -> None:
    ...
    print(f"\n✓ {len(unique_rows)} unique GPT-4o mini bot comments → {OUTPUT_FILE}")
